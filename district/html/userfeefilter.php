...
$query = "SELECT u.*,aft.name,lb.name,lb.type FROM user_fee u INNER JOIN localbody lb ON u.lb_id=lb.id INNER JOIN aft ON lb.aft_id=aft.id"; 
...
$query = "SELECT u.*,aft.name,lb.name,lb.type FROM user_fee u INNER JOIN localbody lb ON u.lb_id=lb.id INNER JOIN aft ON lb.aft_id=aft.id WHERE lb.type='$lb'"; 
...
document.getElementById("print-button").addEventListener("click", function () {
  ...
  printWindow.document.write('<html><head><title>Monthly_userfee</title>');
...
document.getElementById("exportButton").addEventListener("click", function () {
        ...
        a.download = "Monthly_userfee.xls";
