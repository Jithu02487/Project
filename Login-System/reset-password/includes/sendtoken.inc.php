...
if (isset($_POST['resentsend'])) {
    ...
    */
    ...
    $url = "localhost/Forward%20linkage/Login-System/reset-password/index.php?selector=" . $selector . "&validator=" . bin2hex($token);
    ...
    */
    ...
    try {
        ...
        $_SESSION['STATUS']['mailstatus'] = $mail->ErrorInfo;
