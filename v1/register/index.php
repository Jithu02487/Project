        ...
        <div class="col-lg-4">
            ...
            <form class="form-auth" action="includes/register.inc.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="designation" name="designation" class="form-control" placeholder="Designation" required autofocus>
                ...
                <div id="hks" class="form-group mt-4">
                    ...
                    <label for="hks">Select an HKS:</label>
                    ...
                    <?php
                        ...
                        $query = "SELECT id,hks_name FROM hks where v1id='$v1id'";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<option value="' . htmlspecialchars($row['id']) . '">' . htmlspecialchars($row['hks_name']) . '</option>';
