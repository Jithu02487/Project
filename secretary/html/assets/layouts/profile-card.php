...
<div class='card card-profile text-center box-shadow bg-white'>
    ...
    <img alt='' class='card-img-top card-user-cover' src='../assets/images/hks.png'>
    <div class='card-block'>
        <a href='https://github.com/msaad1999/PHP-Login-System'>
            <img src='../assets/images/contact us.png' class='card-img-profile'>
        </a>
        <h5  class='card-title'>
            Forward Linkage
            
            <br>
            <small class="text-muted">Haritha Karma Sena</small>
        </h5>
    </div>
