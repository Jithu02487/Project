...
<head>
    ...
    <script>
        function confirmUpdate() {
            var x = document.forms["editForm"]["new_usertype"].value;
            if (x == "") {
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage_users.php"
                                aria-expanded="false">
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Manage Users - Edit User</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <form id="editForm" name="editForm" action="edit_user_process.php" method="POST">
                    <div class="form-group">
                        <label for="new_userid">User ID:</label>
                        <input type="text" class="form-control" id="id" name="user_id" value="<?php echo $row['id']; ?>" required readonly>
                    </div>

                    <div class="form-group">
                        <label for="fname">First Name:</label>
                        <input type="text" class="form-control" id="fname" name="fname" value="<?php echo $row['first_name']; ?>" required>
                    </div>

                    <div class="form-group">
                        <label for="lname">Last Name:</label>
                        <input type="text" class="form-control" id="lname" name="lname" value="<?php echo $row['last_name']; ?>" required>
                    </div>
                    ...
                    <div class="form-group">            
                        <label for="new_usertype">Role:</label>
                        <select name="new_usertype" id="selectOption" class="form-control">
                            <option value="<?php echo $row['user_type']; ?>"><?php echo $row['user_type']; ?></option>
                            <?php
                            $sql1 = "SELECT DISTINCT user_type FROM users WHERE user_type != '{$row['user_type']}'";
                            $result1 = $conn->query($sql1);

                            while ($row1 = $result1->fetch_assoc()) {
                                echo "<option value='" . $row1['user_type'] . "'>" . $row1['user_type'] . "</option>";
                            }
                            ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">            
                        ...
                        <select name="designation" id="selectOption" class="form-control">
                            <option value="<?php echo $row['designation']; ?>"><?php echo $row['designation']; ?></option>
                            <?php
                            $sql1 = "SELECT DISTINCT designation FROM users WHERE designation != '{$row['designation']}'";
                            $result1 = $conn->query($sql1);
                    ...
                    <a type="button" class="btn btn-secondary" href="manage_users.php">Cancel</a> 
                </form>
                <!-- ============================================================== -->
                <!-- End PAge Content -->
                <!-- ============================================================== -->
