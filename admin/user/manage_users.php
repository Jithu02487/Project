                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="#">
                        ...
                        <span class="logo-text">
                            ...
                            <p style="color:gray; text-align:center; margin: 5px 0;" > KOTTAYAM </p>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <div class="d-md-flex">
                            ...
                            <a href='../../Login-System/register/' class="btn btn-success d-md-block pull-right ms-sm-1 ms-lg-3 text-white">
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="selectuser" id="selectOption" class="form-control">
                                ...
                                <option hidden>--- Select User Type ---</option>
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT DISTINCT user_type FROM users";
                            ...
                            <div class="col">
                                ...
                                <select name="selectdes" id="selectOption" class="form-control">
                                ...
                                <option hidden>--- Select Designation ---</option>
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT DISTINCT designation FROM users";
                    ...
                    <div class="col-sm-12">
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if (isset($_POST["selectuser"],$_POST["selectdes"])) {

                                    $selecteduser = $_POST["selectuser"];

                                    $selecteddes = $_POST["selectdes"];



                                    // Build the SQL query based on the selected filter

                                    if ($selecteduser === "all" && $selecteddes === "all") {

                                        $query = "SELECT * FROM users";

                                    } 

                                    elseif ($selecteduser === "all" && $selecteddes != "all") {

                                        $query = "SELECT * FROM users WHERE designation = '$selecteddes'";

                                    } 

                                    elseif ($selecteduser != "all" && $selecteddes === "all") {

                                        $query = "SELECT * FROM users WHERE user_type = '$selecteduser'";

                                    } 

                                    else {

                                        $query = "SELECT * FROM users WHERE user_type = '$selecteduser' AND designation = '$selecteddes'";
                                    ...
                                    echo '<th class="border-top-0">Email</th>';

                                    echo '<th class="border-top-0">Gender</th>';

                                    echo '<th class="border-top-0">Role</th>';

                                    echo '<th class="border-top-0">Designation</th>';
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            echo "<td>" . convertType($row["gender"]) . "</td>";
