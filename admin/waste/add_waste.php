    ...
    <script>
        function confirmInsert() {
            ...
            if (x == "") {
                ...
                var confirmation = confirm("Are you sure you want to add this waste material?");
                if (confirmation) {
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Waste Materials - Add</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <!-- Start Page Content -->
                <!-- ============================================================== -->
                <form id="insertForm" name="insertForm" action="add_waste_process.php" method="POST">  
     
                     <div class="form-group">
                        <label for="name">Name:</label>
                        <input type="text" class="form-control" name="name" placeholder="Enter Waste Material Name" required>
                    </div>
