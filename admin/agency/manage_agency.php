...
<head>
    ...
    <script>
        ...
        function confirmDelete(aId) {
            ...
            var confirmation = confirm("Are you sure you want to delete agency with ID " + aId + "?");
            ...
            if (confirmation) {
                ...
                window.location.href = 'delete_agency.php?id=' + aId;
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                ...
                <nav class="sidebar-nav">
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            ...
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="manage_agency.php"
        ...
        <div class="page-wrapper" style="min-height: 250px;">
            ...
            <div class="page-breadcrumb bg-white">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <h4 class="page-title">Manage Agency</h4>
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        ...
                        <div class="d-md-flex">
                            ...
                            <a href='#' class="btn btn-danger d-md-block pull-right ms-sm-1 ms-lg-3 text-white">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-12 mycard">
                        ...
                        <div class="white-box analytics-info">
                            ...
                            <h3 class="box-title">Total Agency</h3>
                    ...
                    <div class="col-lg-4 col-md-12 mycard">
                        ...
                        <div class="white-box analytics-info">
                            ...
                            <h3 class="box-title">Request Pendency</h3>
                            ...
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                ...
                                <li class="ms-auto"><span class="counter text-purple">
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT count(*) as a_count FROM temp_agency WHERE status IS NULL";
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="selectOption" id="selectOption" class="form-control">
                                    ...
                                    <option value="total">Total Agency</option>

                                    <option value="pendency">Request Pendency</option>
                        ...
                        <?php
                            ...
                            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                ...
                                if (isset($_POST["selectOption"])) {
                                    ...
                                    else if ($selectedOption === "pendency") {

                                        $query = "SELECT * FROM temp_agency WHERE status IS NULL";
                                    ...
                                    echo '<th class="border-top-0">Address</th>';

                                    echo '<th class="border-top-0">Phone</th>';
                                    ...
                                    if ($result->num_rows > 0) {
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            if ($selectedOption === "pendency") {

                                                echo "<td>

                                                <a href='agency_request.php?id=" . $row["id"] . "'>

                                                    <button type='button' class='btn btn-warning col-lg-12 col-sm-12 col-md-12 col-xs-12'>View Request</button>
                                                ...
                                                <a href='agency_info.php?id=" . $row["id"] . "'>

                                                    <button type='button' class='btn btn-warning col-lg-12 col-sm-12 col-md-12 col-xs-12'>View Details</button>
            ...
            <footer class="footer text-center"> 
                ...
                2024 © LSGD Government of Kerala | Developed by MCA Dept., RIT, Kottayam
