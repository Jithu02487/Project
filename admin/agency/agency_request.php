...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM temp_agency WHERE id = $a_id";
...
<head>
    ...
    <script>
        ...
        function confirmAccept(aId) {

            var confirmation = confirm("Are you sure you want to accept agency ?");
            ...
            if (confirmation) {
                ...
                window.location.href = 'accept_agency.php?id=' + aId;          
        ...
        function confirmDecline(aId) {

            var confirmation = confirm("Are you sure you want to decline agency ?");
            ...
            if (confirmation) {
                ...
                window.location.href = 'decline_agency.php?id=' + aId;     
            ...
            <div class="page-breadcrumb bg-white">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <h4 class="page-title">Agency Info</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <?php
                            ...
                            if ($result->num_rows == 1) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<tr><td>Agency Name</td><td>" . $row["name"] . "</td></tr>";

                                    echo "<tr><td>Address</td><td>" . $row["address"] . "</td></tr>";

                                    echo "<tr><td>Contact Number</td><td>" . $row["phone"] . "</td></tr>";
                                    ...
                                    echo "<tr><td>Applicant Name</td><td>" . $row["p_name"] . "</td></tr>"; 

                                    echo "<tr><td>Designation</td><td>" . $row["designation"] . "</td></tr>";

                                    echo "<tr><td>Contact Number</td><td>" . $row["p_phone"] . "</td></tr>";  

                                    echo "<tr><td colspan='2'>

                                    <a href='#'>

                                        <button type='button' class='btn btn-success col-lg-6 col-sm-6 col-md-6 col-xs-6 text-white' id='deleteBtn' onclick='confirmAccept(" . $row["id"] . ")'>Accept</button>

                                    </a>

                                    <a href='#'>

                                        <button type='button' class='btn btn-danger col-lg-6 col-sm-6 col-md-6 col-xs-6 text-white' id='deleteBtn' onclick='confirmDecline(" . $row["id"] . ")'>Decline</button>
                    ...
                    <div class="col-sm-6">
                        ...
                        <iframe src="request_pdf.php?id=<?php echo $a_id; ?>" width='490' height='620'></iframe>
