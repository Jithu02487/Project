...
<head>
      ...
      <link rel="stylesheet" type="text/css" href="../css/invoicepaid.css">
...
<div id="b">
    ...
    <table id="tb">
      ...
      <form id="myForm" method="POST" action="invoicepaidfilter.php">
    ...
    <tr> <td> Agency </td><td><select name="agency" id="agency">
