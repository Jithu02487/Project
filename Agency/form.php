        ...
        <div class="card card-registration my-4">
             ...
             <div class="col-xl-12">
              <div class="card-body p-md-5 text-black">
                <h3 class="mb-5 text-uppercase">Register your Agency</h3>


                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline text-uppercase">
                    <?php
session_start();
if (isset($_SESSION['STATUS']['registrationstatus'])) {
  $pop=$_SESSION['STATUS']['registrationstatus'];
  unset($_SESSION['STATUS']['registrationstatus']);
  echo "
  <div class='modal fade' id='myModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' aria-hidden='true'>
    <div class='modal-dialog modal-dialog-centered' role='document'>
    <div class='modal-content bg-light bg-gradient' style='background-color: #f7d2c9;'>
        <div class='modal-header'>
          <h5 class='modal-title text-success' id='exampleModalLabel'>Notification</h5>
          <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
            <span aria-hidden='true'>&times;</span>
          </button>
        </div>
        <div class='modal-body'>
          <p class='text-dark'>$pop</p>
        </div>
      </div>
    </div>
  </div>
...
if (isset($_SESSION['ERRORS']['scripterror'])) {
  echo '<span class="error-message">' . $_SESSION['ERRORS']['scripterror'] . '</span>';
  unset($_SESSION['ERRORS']['scripterror']);
}
if (isset($_SESSION['ERRORS']['mail'])) {
  echo '<span class="error-message">' . $_SESSION['ERRORS']['mail'] . '</span>';
  unset($_SESSION['ERRORS']['mail']);
}
if (isset($_SESSION['ERRORS']['name'])) {
  echo '<span class="error-message">' . $_SESSION['ERRORS']['name'] . '</span>';
...
?>
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="AgencyName" name="AgencyName" class="form-control form-control-lg" required />
                ...
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="tel" id="ContactNumber" name="ContactNumber" class="form-control form-control-lg" />
                      <label class="form-label" for="ContactNumber">Contact Number</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                  <div class="form-outline mb-4">
                  <input type="text" id="EmailID" name="EmailID" class="form-control form-control-lg" />
                  <label class="form-label" for="EmailID">Email ID</label>
                  <?php
    
                        if (isset($_SESSION['ERRORS']['emailerror'])) {
                            echo '<p style="color: red;">' . $_SESSION['ERRORS']['emailerror'] . '</p>';
                            $_SESSION['ERRORS']['documenterror'];
                            unset($_SESSION['ERRORS']['emailerror']); // Remove the error message to prevent displaying it again
                        }
                        if (isset($_SESSION['ERRORS']['documenterror'])) {
                          echo '<p style="color: red;">' . $_SESSION['ERRORS']['documenterror'] . '</p>';
                          
                          unset($_SESSION['ERRORS']['documenterror']); // Remove the error message to prevent displaying it again
                      }
                    ?>
                </div>
                  </div>
  ...
  <div class="form-group col-md-4">
    ...
    <select class="form-control" id="inputDistrict" name="inputDistrict">
        <option value="">-- select one -- </option>
                ...
                <div>
                    <h5 class="mb-5 text-uppercase">Contact Details</h5>
                </div>
                <!-- Contact one  -->
                <span class="h5 mb-3 font-weight-normal text-muted text-center">Contact one</span>
                <div class="row">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="Name1" name="Name1" class="form-control form-control-lg" required/>
                      <label class="form-label" for="Name1">Name</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline mb-4">
                      <input type="text" id="Designation1" name="Designation1" class="form-control form-control-lg" required />
                      <label class="form-label" for="Designation1">Designation</label>
                    </div>
                  </div>
                </div>
                <div class="form-outline">
                      <input type="tel" id="CtctNumber1" name="CtctNumber1" class="form-control form-control-lg" required/>
                      <label class="form-label" for="CtctNumber1">Contact Number</label>
                </div>
                      <!-- Contact two  -->
                      <hr>
                <span class="h5 mb-3 font-weight-normal text-muted text-center">Contact two (Optional)</span>
                      <div class="row mt-4">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                  ...
                  <div class="col-md-6 mb-4">
                    <div class="form-outline mb-4">
                      <input type="text" id="Designation2" name="Designation2" class="form-control form-control-lg" />
                      <label class="form-label" for="Designation2">Designation</label>
                    </div>
                  </div>
                </div>
                <div class="form-outline">
                      <input type="tel" id="CtctNumber2" name="CtctNumber2" class="form-control form-control-lg" />
                      <label class="form-label" for="CtctNumber2">Contact Number</label>
                </div>

                  <!-- Contact three -->
                  <hr>
                <span class="h5 mb-3 font-weight-normal text-muted text-center">Contact three (Optional)</span>
                  <div class="row mt-4">
                  <div class="col-md-6 mb-4">
                    <div class="form-outline">
                      <input type="text" id="Name3" name="Name3" class="form-control form-control-lg" />
                      <label class="form-label" for="Name3">Name</label>
                    </div>
                  </div>
                  <div class="col-md-6 mb-4">
                    <div class="form-outline mb-4">
                      <input type="text" id="Designation3" name="Designation3" class="form-control form-control-lg" />
                      <label class="form-label" for="Designation3">Designation</label>
                    </div>
                  </div>
                </div>
                <div class="form-outline">
                      <input type="tel" id="CtctNumber3" name="CtctNumber3" class="form-control form-control-lg" />
                      <label class="form-label" for="CtctNumber3">Contact Number</label>
                </div>

                <div class="d-flex justify-content-end pt-3">
                  <button type="reset" class="btn btn-light btn-lg">Reset all</button>
                  <button type="submit" name="submit" value="Submit" class="btn btn-warning btn-lg ms-2">Submit form</button>
                </div>
